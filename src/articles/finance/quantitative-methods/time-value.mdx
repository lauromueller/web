...
We are now able to determine the future value of a single cash flow, and this can be easily extended for a series of cash flows. Suppose that we decide to invest $$ \$ 1.000,00 $$ every month in an application that pays an interest rate of $$ 1\% $$ per month. How much would we have at the end of $$ 1 $$ year?
