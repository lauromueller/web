...
If we stop to think carefully, we know that our initial application $$ Y $$ at time $$ t = 0 $$ will collect interest from the first month on. In other words, it will collect interest over the entire $$ 12 $$ months of our application. For the sake of clarity, let me clarify that I will assume our periods vary from $$ 0 $$ to $$ 11 $$. It could also be from $$ 1 $$ to $$ 12 $$, it doesn't really matter. For the amount that is deposited in the second period ($$ t = 1 $$), interest will be collected over $$ 11 $$ months rather than the full period. In other words, each monthly deposit further into the future will collect interest over a shorter period. At the end of $$ 12 $$ months we will have the following:
